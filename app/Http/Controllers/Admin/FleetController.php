...
class FleetController extends Controller
{
    ...
    {
        $query = Vehicle::with(['category', 'department', 'assignedDriver', 'currentInsurance'])->orderBy('registration_number');
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.fleet.vehicles.index')->with('success', 'Vehicle ' . $vehicle->registration_number . ' added.');
    }
