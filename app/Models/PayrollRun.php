...
{
    protected $fillable = ['payroll_period_id', 'run_by', 'approved_by', 'status', 'total_basic', 'total_allowances', 'total_deductions', 'total_tax', 'total_net', 'employee_count', 'run_date', 'approved_at', 'notes'];
    protected $casts    = ['total_basic' => 'decimal:2', 'total_allowances' => 'decimal:2', 'total_deductions' => 'decimal:2', 'total_tax' => 'decimal:2', 'total_net' => 'decimal:2', 'run_date' => 'datetime', 'approved_at' => 'datetime'];
