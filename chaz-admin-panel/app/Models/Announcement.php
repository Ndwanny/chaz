...
{
    protected $fillable = ['title', 'content', 'category', 'priority', 'target_audience', 'target_departments', 'is_published', 'published_at', 'expires_at', 'created_by', 'updated_by', 'attachment_path', 'views_count'];
    protected $casts    = ['is_published' => 'boolean', 'published_at' => 'datetime', 'expires_at' => 'datetime', 'target_departments' => 'array'];
