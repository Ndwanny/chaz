...
{
    protected $fillable = ['name', 'code', 'contact_person', 'email', 'phone', 'address', 'city', 'country', 'tax_number', 'bank_name', 'bank_account', 'payment_terms', 'category', 'rating', 'is_active', 'notes'];
