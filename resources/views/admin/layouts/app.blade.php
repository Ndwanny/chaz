...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar__nav">
        ...
        <div class="nav-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
            <a href="{{ route('admin.dashboard') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-gauge"></i> Dashboard</a>
        </div>

        <div class="nav-section">Content</div>
        <div class="nav-item {{ request()->routeIs('admin.news*') ? 'active' : '' }}">
            <a href="{{ route('admin.news.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-newspaper"></i> News Articles</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.jobs*') ? 'active' : '' }}">
            <a href="{{ route('admin.jobs.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-briefcase"></i> Job Postings</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.tenders*') ? 'active' : '' }}">
            <a href="{{ route('admin.tenders.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-file-contract"></i> Tenders</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.members*') ? 'active' : '' }}">
            <a href="{{ route('admin.members.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-hospital"></i> Members</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.downloads*') ? 'active' : '' }}">
            <a href="{{ route('admin.downloads.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-download"></i> Downloads</a>
        </div>

        <div class="nav-section">Inbox</div>
        <div class="nav-item {{ request()->routeIs('admin.messages*') ? 'active' : '' }}">
            <a href="{{ route('admin.messages.index') }}" onclick="closeSidebarOnMobile()">
        ...
        <div class="nav-item {{ request()->routeIs('admin.users*') ? 'active' : '' }}">
            <a href="{{ route('admin.users.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-users-cog"></i> Users</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.roles*') ? 'active' : '' }}">
            <a href="{{ route('admin.roles.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-user-shield"></i> Roles</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.departments*') ? 'active' : '' }}">
            <a href="{{ route('admin.departments.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-sitemap"></i> Departments</a>
        </div>
        @endif

        @if(admin_can('view_employees') || admin_can('manage_employees'))
        <div class="nav-section">Human Resources</div>
        <div class="nav-item {{ request()->routeIs('admin.employees*') ? 'active' : '' }}">
            <a href="{{ route('admin.employees.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-id-badge"></i> Employees</a>
        </div>
        @endif
        @if(admin_can('view_leave') || admin_can('manage_hr'))
        <div class="nav-item {{ request()->routeIs('admin.leave*') ? 'active' : '' }}">
            <a href="{{ route('admin.leave.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-calendar-minus"></i> Leave</a>
        </div>
        @endif
        @if(admin_can('manage_hr') || admin_can('super_admin'))
        <div class="nav-item {{ request()->routeIs('admin.portal-accounts*') ? 'active' : '' }}">
            <a href="{{ route('admin.portal-accounts.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-id-card"></i> Portal Accounts</a>
        </div>
        @endif
        ...
        <div class="nav-item {{ request()->routeIs('admin.payroll*') ? 'active' : '' }}">
            <a href="{{ route('admin.payroll.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-money-bill-wave"></i> Payroll</a>
        </div>
        @endif

        @if(admin_can('view_procurement') || admin_can('manage_procurement'))
        <div class="nav-section">Procurement</div>
        <div class="nav-item {{ request()->routeIs('admin.requisitions*') ? 'active' : '' }}">
            <a href="{{ route('admin.requisitions.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-file-lines"></i> Requisitions</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.purchase-orders*') ? 'active' : '' }}">
            <a href="{{ route('admin.purchase-orders.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-file-invoice"></i> Purchase Orders</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.suppliers*') ? 'active' : '' }}">
            <a href="{{ route('admin.suppliers.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-truck"></i> Suppliers</a>
        </div>
        @endif

        @if(admin_can('view_inventory') || admin_can('manage_inventory'))
        <div class="nav-section">Inventory</div>
        <div class="nav-item {{ request()->routeIs('admin.inventory*') ? 'active' : '' }}">
            <a href="{{ route('admin.inventory.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-boxes-stacked"></i> Stock & Items</a>
        </div>
        @endif

        @if(admin_can('view_fleet') || admin_can('manage_fleet'))
        <div class="nav-section">Fleet</div>
        <div class="nav-item {{ request()->routeIs('admin.fleet.vehicles*') ? 'active' : '' }}">
            <a href="{{ route('admin.fleet.vehicles.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-car"></i> Vehicles</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.fleet.trips*') ? 'active' : '' }}">
            <a href="{{ route('admin.fleet.trips.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-route"></i> Trips</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.fleet.fuel*') ? 'active' : '' }}">
            <a href="{{ route('admin.fleet.fuel.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-gas-pump"></i> Fuel Logs</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.fleet.maintenance*') ? 'active' : '' }}">
            <a href="{{ route('admin.fleet.maintenance.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-wrench"></i> Maintenance</a>
        </div>
        @endif

        @if(admin_can('view_finance') || admin_can('manage_finance'))
        <div class="nav-section">Finance</div>
        <div class="nav-item {{ request()->routeIs('admin.finance.budgets*') ? 'active' : '' }}">
            <a href="{{ route('admin.finance.budgets.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-chart-pie"></i> Budgets</a>
        </div>
        <div class="nav-item {{ request()->routeIs('admin.finance.expenses*') ? 'active' : '' }}">
            <a href="{{ route('admin.finance.expenses.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-receipt"></i> Expenses</a>
        </div>
        @endif

        @if(admin_can('manage_content') || admin_can('manage_comms'))
        <div class="nav-item {{ request()->routeIs('admin.announcements*') ? 'active' : '' }}">
            <a href="{{ route('admin.announcements.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-bullhorn"></i> Announcements</a>
        </div>
        @endif
        ...
        <div class="nav-item {{ request()->routeIs('admin.reports*') ? 'active' : '' }}">
            <a href="{{ route('admin.reports.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-chart-bar"></i> Reports</a>
        </div>
        @endif

        <div class="nav-section">System</div>
        <div class="nav-item {{ request()->routeIs('admin.settings*') ? 'active' : '' }}">
            <a href="{{ route('admin.settings.index') }}" onclick="closeSidebarOnMobile()"><i class="fa fa-gear"></i> Settings</a>
        </div>
        <div class="nav-item">
            <a href="{{ route('home') }}" target="_blank"><i class="fa fa-arrow-up-right-from-square"></i> View Website</a>
        </div>
    </nav>

    <div class="sidebar__footer">
        <div class="sidebar__user">
            <div class="sidebar__avatar">{{ strtoupper(substr(session('admin_name','A'),0,1)) }}</div>
            <div style="min-width:0;">
                <div class="sidebar__user-name">{{ session('admin_name', 'Administrator') }}</div>
                <div class="sidebar__user-role">{{ session('admin_role', 'admin') }}</div>
            </div>
        </div>
...
<div class="main-wrap">
    <header class="topbar">
        ...
        <div class="topbar__right">
            ...
            <a href="{{ route('home') }}" target="_blank" class="topbar__btn topbar__btn--outline">
    ...
    <main class="page-content">
        ...
        @endif
        @if(session('error'))
        <div class="alert alert-error"><i class="fa fa-circle-xmark"></i> {{ session('error') }}</div>
        @endif
