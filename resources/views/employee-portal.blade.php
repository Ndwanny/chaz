    ...
    <div class="container">
        <div class="portal-hero-grid">
            ...
            <div id="portal-login" class="portal-login-card fade-in">
                ...
                @if(session('error'))
                <div style="background:rgba(220,38,38,0.15);border:1px solid rgba(220,38,38,0.4);border-radius:8px;padding:10px 14px;margin-bottom:1rem;color:#fca5a5;font-size:.85rem;">{{ session('error') }}</div>
                @endif
                @if(session('success'))
                <div style="background:rgba(34,197,94,0.15);border:1px solid rgba(34,197,94,0.4);border-radius:8px;padding:10px 14px;margin-bottom:1rem;color:#86efac;font-size:.85rem;">{{ session('success') }}</div>
                @endif
                <form action="{{ route('portal.login') }}" method="POST">
                    ...
                    <div style="position:relative; margin-bottom:0;">
                        ...
                        <input type="text" name="staff_number" class="portal-input" style="padding-left:2.5rem;" placeholder="Staff Number (e.g. CHAZ-0001)" value="{{ old('staff_number') }}" required>
                    </div>
                    <div style="position:relative; margin-bottom:0;">
