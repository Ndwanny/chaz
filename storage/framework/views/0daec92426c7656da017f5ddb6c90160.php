<?php $__env->startSection('title', 'CHAZ — Churches Health Association of Zambia'); ?>
    ...
    <div class="container">
        <div class="home-hero__content">
            ...
            <div class="home-hero__actions">
                <a href="<?php echo e(route('about')); ?>" class="btn btn--gold btn--lg">Discover CHAZ</a>
                <a href="<?php echo e(route('news')); ?>" class="btn btn--outline-white btn--lg">Latest News</a>
            </div>
...
<div class="partners-strip">
    <div class="container">
        ...
        <div class="partners-logos">
            <?php $__currentLoopData = ['Global Fund', 'PEPFAR', 'CDC', 'GAVI', 'WHO', 'UNICEF', 'Ministry of Health', 'Clinton Foundation', 'Irish Aid', 'European Union']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="partner-logo"><?php echo e($p); ?></span>
        ...
        <div class="achievements-grid">
            ...
            <div class="achievement-card fade-in">
                <div class="achievement-card__icon">
                    <i class="fa <?php echo e($a['icon']); ?>"></i>
                </div>
                <div class="achievement-card__num" data-target="<?php echo e(rtrim($a['num'], '%')); ?>" data-suffix="<?php echo e(str_contains($a['num'], '.') ? '' : ''); ?><?php echo e($a['suffix']); ?>">
                    <?php echo e($a['num']); ?><?php echo e($a['suffix']); ?>

                </div>
                <div class="achievement-card__label"><?php echo e($a['label']); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="section">
    <div class="container">
        <div class="section-header" style="display:flex; justify-content:space-between; align-items:flex-end; flex-wrap:wrap; gap:1rem;">
            ...
            <a href="<?php echo e(route('news')); ?>" class="btn btn--outline">All News <i class="fa fa-arrow-right"></i></a>
        </div>
...
<section class="cta-banner">
    <div class="container">
        ...
        <div class="cta-banner__actions">
            <a href="<?php echo e(route('contact')); ?>" class="btn btn--gold btn--lg">Get Involved</a>
            <a href="<?php echo e(route('about')); ?>" class="btn btn--outline-white btn--lg">Learn More</a>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\dev\chaz\resources\views/home.blade.php ENDPATH**/ ?>