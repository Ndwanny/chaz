<?php $__env->startSection('title', 'Sub-Recipient Adverts — CHAZ'); ?>
...
<div class="page-hero">
    <div class="container">
        ...
        <div class="page-hero__breadcrumb">
            <a href="<?php echo e(route('home')); ?>">Home</a> / <a href="<?php echo e(route('tenders')); ?>">Tenders</a> / Sub-Recipient Adverts
        </div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="fade-in" style="background:white;border:1px solid var(--color-border);border-radius:var(--radius-md);margin-bottom:2.5rem;overflow:hidden;box-shadow:var(--shadow-sm);">
            ...
            <div style="background:linear-gradient(135deg,var(--color-forest),var(--color-forest-mid));padding:1.75rem 2rem;display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:1rem;">
                <div>
                    <div style="font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:var(--color-gold);margin-bottom:0.5rem;"><?php echo e($advert->reference); ?></div>
                    <h3 style="font-family:var(--font-display);font-size:1.15rem;font-weight:700;color:white;line-height:1.4;max-width:680px;"><?php echo e($advert->title); ?></h3>
                </div>
                <span class="<?php echo e($advert->status === 'open' ? 'badge badge--green' : 'badge badge--red'); ?>" style="flex-shrink:0;"><?php echo e(ucfirst($advert->status)); ?></span>
            </div>
            ...
            <div style="padding:2rem;">
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(300px, 1fr));gap:2rem;">
                    ...
                    <div>
                        ...
                        <ul style="display:flex;flex-direction:column;gap:0.6rem;">
                            <?php $__currentLoopData = $advert->eligibility_criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($advert->successful_applicants): ?>
                    <div>
                        <h4 style="font-family:var(--font-display);font-size:1rem;color:var(--color-forest);margin-bottom:1rem;display:flex;align-items:center;gap:0.5rem;">
                            <i class="fa fa-award" style="color:var(--color-gold);"></i> Successful Applicants
                        </h4>
                        <ul style="display:flex;flex-direction:column;gap:0.6rem;">
                            <?php $__currentLoopData = $advert->successful_applicants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $org): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li style="font-size:0.85rem;color:var(--color-slate-mid);line-height:1.6;display:flex;gap:0.6rem;align-items:flex-start;">
                ...
                <?php if($advert->status === 'open' && $advert->document): ?>
                <div style="margin-top:2.5rem;padding-top:1.5rem;border-top:1px solid var(--color-border);display:flex;justify-content:flex-end;">
                    <a href="<?php echo e(asset('storage/' . $advert->document)); ?>" class="btn btn--forest"><i class="fa fa-download"></i> Download Full Advert Docs</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\dev\chaz\resources\views/tenders/sub-recipient-adverts.blade.php ENDPATH**/ ?>