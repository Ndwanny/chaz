<?php $__env->startSection('title', 'Record Fuel'); ?>
<?php $__env->startSection('breadcrumb', 'Fleet / Fuel / Record'); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <div><div class="page-title">Record Fuel</div></div>
    <a href="<?php echo e(route('admin.fleet.fuel.index')); ?>" class="btn btn-outline"><i class="fas fa-arrow-left"></i> Back</a>
</div>

<div class="card" style="max-width:680px;">
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('admin.fleet.fuel.store')); ?>">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                ...
                <div>
                    ...
                    <input type="date" name="log_date" class="form-control" value="<?php echo e(old('log_date', date('Y-m-d'))); ?>" required>
                </div>
                <div>
                    <label class="form-label">Odometer Reading (km)</label>
                    <input type="number" name="odometer_reading" class="form-control" value="<?php echo e(old('odometer_reading')); ?>" min="0">
                </div>
                <div>
                    <label class="form-label">Litres <span style="color:red;">*</span></label>
                    <input type="number" name="litres" class="form-control" value="<?php echo e(old('litres')); ?>" step="0.01" min="0.1" required>
                </div>
                <div>
                    <label class="form-label">Unit Cost (ZMW/L) <span style="color:red;">*</span></label>
                    <input type="number" name="unit_cost" class="form-control" value="<?php echo e(old('unit_cost')); ?>" step="0.01" min="0" required>
                </div>
                <div>
                    <label class="form-label">Fuel Station</label>
                    <input type="text" name="fuel_station" class="form-control" value="<?php echo e(old('fuel_station')); ?>" maxlength="100">
                </div>
                <div>
                    <label class="form-label">Receipt Number</label>
                    <input type="text" name="receipt_number" class="form-control" value="<?php echo e(old('receipt_number')); ?>" maxlength="30">
                </div>
            ...
            <div style="margin-top:20px;display:flex;gap:10px;">
                ...
                <a href="<?php echo e(route('admin.fleet.fuel.index')); ?>" class="btn btn-outline">Cancel</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\dev\chaz\resources\views/admin/fleet/fuel/form.blade.php ENDPATH**/ ?>