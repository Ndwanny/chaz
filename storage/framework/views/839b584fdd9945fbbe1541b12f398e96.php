<?php $__env->startSection('title', 'Downloads — CHAZ'); ?>
...
<div class="page-hero">
    <div class="container">
        ...
        <div class="page-hero__breadcrumb"><a href="<?php echo e(route('home')); ?>">Home</a> / Downloads</div>
    </div>
</div>
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2rem;max-width:900px;margin:0 auto;">
            ...
            <a href="<?php echo e(route($cat['route'])); ?>" class="fade-in" style="background:white;border:1px solid var(--color-border);border-radius:var(--radius-md);padding:2.5rem 2rem;text-align:center;display:block;transition:all .3s;" onmouseover="this.style.transform='translateY(-5px)';this.style.boxShadow='var(--shadow-lg)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                <div style="width:64px;height:64px;background:var(--color-forest);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 1.5rem;">
                    <i class="fa <?php echo e($cat['icon']); ?>" style="color:var(--color-gold);font-size:1.4rem;"></i>
                </div>
                <h3 style="font-family:var(--font-display);font-size:1.2rem;color:var(--color-forest);margin-bottom:0.6rem;"><?php echo e($cat['title']); ?></h3>
                <p style="font-size:0.875rem;color:var(--color-slate-mid);line-height:1.7;margin-bottom:1rem;"><?php echo e($cat['desc']); ?></p>
                <span class="badge badge--green"><?php echo e($cat['count']); ?></span>
            </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\dev\chaz\resources\views/downloads/index.blade.php ENDPATH**/ ?>