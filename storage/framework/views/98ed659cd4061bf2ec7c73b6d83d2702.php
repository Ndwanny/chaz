<?php $__env->startSection('title', 'Donate — Support CHAZ'); ?>
<?php $__env->startSection('meta_description', 'Support the Churches Health Association of Zambia. Your donation funds HIV, TB, Malaria, maternal health and community health programmes across Zambia.'); ?>
...
<div class="donate-hero">
    ...
    <div class="container donate-hero__inner">
        ...
        <div class="donate-hero__breadcrumb"><a href="<?php echo e(route('home')); ?>">Home</a> / Donate</div>
    </div>
</div>
        ...
        <div class="donate-form-wrap">
            ...
            <div class="donate-card">
                ...
                <div class="donate-alert donate-alert--error">
                    <i class="fa fa-circle-exclamation"></i> <?php echo e($errors->first('payment')); ?>

                </div>
                <?php endif; ?>

                <form action="<?php echo e(route('donate.initiate')); ?>" method="POST" id="donateForm" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="donate-field-group">
                        ...
                        <div class="donate-amount-grid">
                            <?php $__currentLoopData = [50, 100, 250, 500, 1000, 2500]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $preset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" class="donate-amount-btn <?php echo e(old('amount') == $preset ? 'active' : ''); ?>" data-amount="<?php echo e($preset); ?>">
                                ZMW <?php echo e(number_format($preset)); ?>

                            </button>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" class="donate-amount-btn donate-amount-btn--custom <?php echo e(!in_array(old('amount'), [50,100,250,500,1000,2500]) && old('amount') ? 'active' : ''); ?>" data-custom>
                                Custom
                            </button>
                        </div>
                        <div class="donate-custom-wrap" id="customAmountWrap" style="<?php echo e((!in_array(old('amount'), [50,100,250,500,1000,2500]) && old('amount')) ? '' : 'display:none;'); ?>">
                            <span class="donate-currency-prefix">ZMW</span>
                            <input type="number" name="amount" id="amountInput" class="donate-input donate-input--amount <?php $__errorArgs = ['amount'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="donate-error"><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    </div>
                    ...
                    <div class="donate-field-group">
                        ...
                        <select name="fund" id="fund" class="donate-select <?php $__errorArgs = ['fund'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="General Fund" <?php echo e(old('fund') == 'General Fund' ? 'selected' : ''); ?>>General Fund (where most needed)</option>
                            <option value="HIV & AIDS Programme" <?php echo e(old('fund') == 'HIV & AIDS Programme' ? 'selected' : ''); ?>>HIV &amp; AIDS Programme</option>
                            <option value="Tuberculosis Programme" <?php echo e(old('fund') == 'Tuberculosis Programme' ? 'selected' : ''); ?>>Tuberculosis (TB) Programme</option>
                            <option value="Malaria Programme" <?php echo e(old('fund') == 'Malaria Programme' ? 'selected' : ''); ?>>Malaria Programme</option>
                            <option value="Maternal & Child Health" <?php echo e(old('fund') == 'Maternal & Child Health' ? 'selected' : ''); ?>>Maternal &amp; Child Health</option>
                            <option value="Nutrition Programme" <?php echo e(old('fund') == 'Nutrition Programme' ? 'selected' : ''); ?>>Nutrition Programme</option>
                            <option value="Community Health Workers" <?php echo e(old('fund') == 'Community Health Workers' ? 'selected' : ''); ?>>Community Health Workers</option>
                            <option value="Infrastructure & Equipment" <?php echo e(old('fund') == 'Infrastructure & Equipment' ? 'selected' : ''); ?>>Infrastructure &amp; Medical Equipment</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="donate-field-row">
                        <div class="donate-field-group">
                            ...
                            <input type="text" name="first_name" id="first_name" class="donate-input <?php $__errorArgs = ['first_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('first_name')); ?>" placeholder="Jane" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="donate-field-group">
                            ...
                            <input type="text" name="last_name" id="last_name" class="donate-input <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('last_name')); ?>" placeholder="Mwale" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="donate-field-row">
                        <div class="donate-field-group">
                            ...
                            <input type="email" name="email" id="email" class="donate-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="donate-field-group">
                            ...
                            <input type="tel" name="phone" id="phone" class="donate-input <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('phone')); ?>" placeholder="+260 97X XXXXXX">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="donate-field-group">
                        ...
                        <textarea name="message" id="message" rows="3" class="donate-input <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Leave a message of support or dedication..."><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="donate-payment-methods">
                        <div class="donate-payment-methods__label"><i class="fa fa-lock"></i> Secure payment methods accepted</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\dev\chaz\resources\views/donate.blade.php ENDPATH**/ ?>