<?php $__env->startSection('title', 'New Budget'); ?>
<?php $__env->startSection('breadcrumb', 'Finance / Budgets / New'); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <div><div class="page-title">Create Budget</div></div>
    <a href="<?php echo e(route('admin.finance.budgets.index')); ?>" class="btn btn-outline"><i class="fas fa-arrow-left"></i> Back</a>
</div>
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('admin.finance.budgets.store')); ?>">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:20px;">
                <div>
                    ...
                    <select name="budget_period_id" class="form-control" required>
                        ...
                        <option value="<?php echo e($p->id); ?>" <?php echo e(old('budget_period_id') == $p->id ? 'selected' : ''); ?>><?php echo e($p->name); ?></option>
                ...
                <div>
                    ...
                    <input type="number" name="total_budget" class="form-control" value="<?php echo e(old('total_budget')); ?>" step="0.01" min="0" required>
                </div>
            ...
            <div style="margin-top:24px;display:flex;gap:10px;">
                ...
                <a href="<?php echo e(route('admin.finance.budgets.index')); ?>" class="btn btn-outline">Cancel</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\dev\chaz\resources\views/admin/finance/budgets/form.blade.php ENDPATH**/ ?>